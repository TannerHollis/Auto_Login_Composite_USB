 ...
 *      Author: THollis
 *        From: https://controllerstech.com/flash-programming-in-stm32/
 *       About: For ease of use in allocating memory, buffers are designated using a custom data
 *       	 	region in flash as ".user_data" attribute in the linker script.
 */
